...
class RegistrationForm extends Component {
  ...
  renderLastNameField = () => {
    ...
    const nameClassName = showLastNameError
  ...
  renderFirstNameField = () => {
    ...
    const nameClassName = showFirstNameError
      ? 'name-input-field error-field'
      : 'name-input-field'
